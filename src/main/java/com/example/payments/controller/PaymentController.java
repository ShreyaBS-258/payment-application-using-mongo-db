...
public class PaymentController {
    ...
    // 4. Endpoint to find completed and pending payments by date
    ...
    public ResponseEntity<Map<String, List<Payment>>> getPaymentsByStatusAndDate(@PathVariable String paymentDate) {
        Map<String, List<Payment>> paymentsByStatus = paymentService.getPaymentsByStatusAndDate(paymentDate);
        return new ResponseEntity<>(paymentsByStatus, HttpStatus.OK);
    }
